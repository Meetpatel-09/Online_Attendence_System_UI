...
export default function AddUser() {
  ...
  const apiGetCardId = "http://localhost:80/rfid/api/card_id/read.php";
  const apiRemoveCardId = "http://localhost:80/rfid/api/card_id/delete.php";
  const apiCreateUser = "http://localhost:80/rfid/api/user/create.php";
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      let reqData = JSON.stringify({
        ...
        name: inputs.user_name + " " + inputs.last_name,
        email: inputs.email,
